...
<!--  <h1>Lorem Ipsum</h1>
  ...
  <div class="my-5">
    ...
    <h1 class="mt-0">   <img class="align-self-start mr-3" src="<?= $config['homePage'] ?>/img/website.png" width=8%><?= $i18n->getText('006') ?></h1>
    <p><?= $i18n->getText('011') ?></p>
    <br />    <br />    <br />

    <h1 class="mt-0">   <img class="align-self-start mr-3" src="<?= $config['homePage'] ?>/img/customer.png" width=8%><?= $i18n->getText('007') ?></h1>
    <p><?= $i18n->getText('012') ?></p>
    <br />    <br />    <br />

    <h1 class="mt-0">   <img class="align-self-start mr-3" src="<?= $config['homePage'] ?>/img/folder-management.png" width=8%><?= $i18n->getText('008') ?></h1>
    <p><?= $i18n->getText('013') ?></p>
    <br />    <br />    <br />

    <h1 class="mt-0">   <img class="align-self-start mr-3" src="<?= $config['homePage'] ?>/img/customer-service.png" width=8%><?= $i18n->getText('009') ?></h1>
    <p><?= $i18n->getText('014') ?></p>
    <br />    <br />    <br />

    <h1 class="mt-0">   <img class="align-self-start mr-3" src="<?= $config['homePage'] ?>/img/block.png" width=8%><?= $i18n->getText('010') ?></h1>
    <p><?= $i18n->getText('015') ?></p>
    <br />    <br />    <br />
